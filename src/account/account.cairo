...
mod Account {
    ...
    // locals
    use circuitbreaker::introspection::erc165::{ERC165};
    // use rules_utils::utils::into::BoolIntoU8;
    use circuitbreaker::account;
    ...
    impl UpgradeImpl of UpgradeTrait {
        fn upgrade(ref self: ContractState, new_implementation: starknet::ClassHash) {
            ...
            assert(res.len() == 1, 'Account: invalid implementation');
            assert(*res.at(0) == 1, 'Account: invalid implementation');
